          ...
          $json['ssl_privatekey_full_path'] = '';
           ...
           $query_one .= mysqli_query($con, "INSERT INTO `users` (
            ...
            VALUES ('" . mysqli_real_escape_string($con, $_POST['admin_username']). "', '" . mysqli_real_escape_string($con, sha1($_POST['admin_password'])) . "','" . mysqli_real_escape_string($con, $_POST['siteEmail']) . "'
                ,'1', '1', '00/0000')");
           $success = 'OpenTube successfully installed, please wait ..';
        } else {
          $ServerErrors[] = "Error found while installing, please contact us.";
        }
      }
...
<html>
	...
	<head>
		...
		<title>OpenTube | Installation</title>
...
?>
						...
						<div class="wo_install_step">
							<ul class="install_steps">
								<li class="step-one <?php echo ($page == 'terms') ? 'active': '';?>">
									<span>1<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Политика пользования
								</li>
								<li class="step-two <?php echo ($page == 'req') ? 'active': '';?>">
									<span>2<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Проверка
								</li>
								<li class="step-three <?php echo ($page == 'installation') ? 'active': '';?>">
									<span>3<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg></span>Установка
								</li>
								<li class="step-four <?php echo ($page == 'finish') ? 'active': '';?>"><span>4</span>Готово</li>
							</ul>
                                ...
                                <div class="terms">
									...
									<form action="?page=req" method="post">
										<div class="wo_terms">
											...
											<label for="agree"> Я согласен с правилами пользования Cms!</label>
										</div>
										<br><br>
										<button type="submit" class="btn btn-main" id="next-terms" disabled>Далее <svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z"></path></svg></button>
    ...
    <tbody>
      ...
      <tr>
        <td>opentube.sql</td>
        <td>Required opentube.sql for the installation <small>(Located in ./Script)</small></td>
      ...
      <tr>
        ...
        <td><?php echo ($is_writable_json == true) ? '<font color="green"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M9.707 17.707l10-10-1.414-1.414L9 15.586l-4.293-4.293-1.414 1.414 5 5a.997.997 0 0 0 1.414 0z"/></svg> Executable</font>' : '<font color="red"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="currentColor" d="M6.707 18.707L12 13.414l5.293 5.293 1.414-1.414L13.414 12l5.293-5.293-1.414-1.414L12 10.586 6.707 5.293 5.293 6.707 10.586 12l-5.293 5.293z"/></svg> Not executable</font>'?></td>
                                ...
                                <?php } else if ($page == 'finish') { ?>
									<div class="req">
										<p>Ура! Ваш сайт на CMS OpenTube почти готов.</p>
										<p>Осталось ввести данные и войти в админ-панель что бы поменять настройки по вашему усмотрению.</p>
										<br>
										<p>Если у вас остались вопросы, пожалуйста <a href="mailto:support@open-tube.ru" class="main">свяжитесь с нами!</a>.</p>
										<br><br>
										<a href="../" class="btn btn-main" style="line-height: 50px;">Поехали!</a>
									</div>
                                   ...
                                   <?php } ?>
                                    <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteName">Введите сюда любые символы </label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="purshase_code" value="<?php echo (!empty($_POST['purshase_code'])) ? $_POST['purshase_code']: '';?>">
                                                <span class="help-block">Да, так устроена CMS</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteName">Url или Ip базы SQL </label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteTitle">Имя пользователя SQL</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteName">Пароль SQL </label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteTitle">Имя базы данных SQL</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="site_url">URL сайта</label>
                                            <div class="col-md-6">
                                              <?php
                                              ...
                                              ?>
                                                ...
                                                <span class="help-block">Пример: <br>http://open-tube.ru<br> http://www.open-tube.ru<br> http://subdomain.opentube.ru<br> http://open-tube.ru/subfolder<br> Вы можете использовать https:// тоже.</span>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteEmail">Имя сайта</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteEmail">Слоган сайта</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteEmail">E-Mail сайта</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteEmail">Имя пользователя Администратора</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
											<div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteEmail">Пароль Администратора</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                Заметка: Процесс установки может занять некоторое время.
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group last-btn">
                                           ...
                                           <div class="col-md-8">
												<button type="submit" onclick="Wo_SubmitButton();" class="btn btn-main" <?php echo ($disabled == true) ? 'disabled': '';?>>Установить <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="19" height="19"><path fill="currentColor" d="M10,17L6.5,13.5L7.91,12.08L10,14.17L15.18,9L16.59,10.41M19.35,10.03C18.67,6.59 15.64,4 12,4C9.11,4 6.6,5.64 5.35,8.03C2.34,8.36 0,10.9 0,14A6,6 0 0,0 6,20H19A5,5 0 0,0 24,15C24,12.36 21.95,10.22 19.35,10.03Z"></path></svg></button>
                                           </div>
                                        </div>
                                    </form>
                                </div>
